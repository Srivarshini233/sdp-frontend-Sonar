        ...
        <div className='h-[40vh] w-[50vw] flex flex-row shadow-md shadow-orange-500/20'>
          <div className='w-1/2 h-full flex flex-col'>
            <div className='h-1/6 w-full flex justify-end items-center px-3 gap-3'>
              <button className='p-2 border-2  hover:border-orange-700 hover:bg-orange-200/40 rounded-full' onClick={() => { setEditmodel(true) }}>
                <Pencil className='text-blue-300' />
              </button>
              <button className='p-2 border-2 hover:border-orange-700 hover:bg-orange-200/40 rounded-full' onClick={() => { setEditkeymodel(true) }}>
                <Key className='text-blue-300' />
              </button>
            </div>
            ...
            <div className='h-2/6 w-full flex justify-center items-center'>
              <p className='text-3xl font-bold text-blue-700'> {userdata.name} </p>
            </div>
          </div>
          <div className='w-1/2 h-full flex justify-center items-center flex-col'>
            <div className='h-1/4 w-full flex flex-row border-2 border-orange-100/50'>
              <div className='w-1/3 h-full flex items-center justify-start text-blue-400 font-bold bg-orange-100/10 px-4'>
                Email
              </div>
