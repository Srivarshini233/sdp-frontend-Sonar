...
const Login = () => {
    ...
    return (
        <>
            <div className='bg-container p-0 m-0 h-[90vh] mt-20 w-screen flex justify-center items-center flex-col bg-amber-200 '>
                <form className='flex flex-col gap-5 bg-slate-50/80 h-3/6 w-[30%] items-center justify-center rounded-md shadow-md shadow-orange-100' onSubmit={handleLogin}>
                    ...
                    <button type="submit" className='w-[80%] bg-slate-500 text-white p-2 rounded-sm font-bold mt-4 shadow-md shadow-orange-500/40'>Login</button>
                    <p>Don't have an account ? <span className='text-blue-700cursor-pointer font-bold' onClick={() => navigate('/register')}> Register ! </span></p>
                </form>
            </div>
            <Toaster />
        </>
