...
const Register = () => {
    ...
    return (
        <>
            <div className='p-0 m-0 h-[140vh] w-screen flex justify-center items-center flex-col  bg-amber-200  mt-20'>
                <form className='flex flex-col gap-5 bg-slate-50/80 h-5/6 w-[30%] items-center justify-center rounded-md shadow-md shadow-orange-100' onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className='w-[80%] bg-gradient-to-t bg-blue-600 to-orange-300 text-white p-2 rounded-sm font-bold mt-4 shadow-md shadow-orange-500/40'>Register</button>
